...
import { getSortedRouteObjects } from '../shared/lib/router/utils/sorted-routes'
        ...
        await staticGenerationSpan.traceAsyncFn(async () => {
          ...
          staticPaths.forEach((prerenderedRoutes, originalAppPath) => {
            ...
            for (const prerenderedRoute of prerenderedRoutes) {
              ...
              if (
                prerenderedRoute.unknownRouteParams &&
                prerenderedRoute.unknownRouteParams.length > 0
              ) {
            ...
            // Handle all the dynamic routes.
            for (const { path: route, unknownRouteParams } of dynamicRoutes) {
              const normalizedRoute = normalizePagePath(route)
              ...
              let initialRevalidateSeconds: Revalidate | undefined
              ...
              if (unknownRouteParams && unknownRouteParams.length > 0) {
                fallbackMode = FallbackMode.SERVE_STATIC_PRERENDER
              ...
              prerenderManifest.dynamicRoutes[route] = {
                ...
                dataRoute,
                fallback,
                fallbackRevalidate: initialRevalidateSeconds,
